...
Project-native audit overlays are tracked in `docs/AUDIT_OVERLAYS.md` and `overlays/`.
Parallel fan-out requirements are tracked in `docs/PARALLEL_FANOUT_CONTRACT.md`.
