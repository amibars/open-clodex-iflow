...
| Windowed default orchestration | Implemented as visible sequential runtime | `/orch` defaults to `windowed`; current truth is operator-visible current-terminal execution, not dedicated OS windows per lane |
